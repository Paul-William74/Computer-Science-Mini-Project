...
public class MainTestKNN {
    ...
    public static void main(String[] args) {
        try {
            KNNClassifier<Node, Double> knn = TrainingLoader.loadTrainingData(3);

            ImageProcessor processor = new ImageProcessor();
            Graph<Node, Double> testGraph =
                    processor.buildNodeGraph(new File("Datasets/tests/images/01_test.tif"));
